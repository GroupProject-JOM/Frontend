(function ($) {
  $.fn.glanceyear = function (massive, options) {
      ...
      for (var j = firstDate.getDay(); j < 7; j++) {
        ...
        if (dayCount >= 0 || (settings.showToday && dayCount >= -1)) {
          ...
          rectElement.onmouseover = function () {
            ...
            if (tagCountData) {
              if (tagCountData > 1)
                tagCount = $(this).attr("data-count") + " distributions";
              else tagCount = $(this).attr("data-count") + " distributions";
            } else {
              tagCount = "No distributions";
            }
            ...
            $_tag
              ...
              .show()
              .css({
                left: $(this).offset().left - $_tag.outerWidth() / 1.067,
    ...
    function getBeautyDate(a) {
      return (
        getNameMonth(a.getMonth()) + " " + a.getDate() + ", " + a.getFullYear()
      );
    }
