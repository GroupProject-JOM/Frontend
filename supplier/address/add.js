(() => {
  ...
  var data = {
    sin: {
      ...
      sText: "නව වතු ස්ථානයක් සඳහා තොරතුරු එක් කරන්න. <br />ඔබට ඕනෑම වේලාවක උපකරණ පුවරුව > ලිපිනයන් හිදී මෙම තොරතුරු සංස්කරණය කළ හැක",
      ename: "වතු නම",
      location: "ස්ථානය",
    ...
    en: {
      ...
      sText: "Add information for a new estate location. <br />You can edit these information any time at Dashboard > Addresses",
      ename: "Estate Name",
      location: "Location",
