...
.multiselect-dropdown-list-wrapper{
  ...
  box-shadow: 0px 4px 40px 0px var(--box-shadow);
  z-index: 100;
  padding:2px;
  border-radius: 4px;
...
function MultiselectDropdown(options) {
  var config = {
    search: true,
    height: "15rem",
    placeholder: "Select production requests used for the batch",
  ...
  document.querySelectorAll("select[multiple]").forEach((el, k) => {
    ...
    el.loadOptions = () => {
      ...
      div.refresh = () => {
        div.querySelectorAll("span.optext, span.placeholder").forEach((t) => {
          div.removeChild(t);
        });
